 ...
 * 
 * @version $Id: 6e1cee9d66e09c20ee764382972265a5f2ff5f5b $
 */
public class InsertColAfter extends AbstractTableFeature
{
     ...
     * Feature name.
     */
    public static final String NAME = "insertcolafter";
    ...
    {
        super(NAME, new Command(NAME), Strings.INSTANCE.insertColAfter(), plugin);
    }
