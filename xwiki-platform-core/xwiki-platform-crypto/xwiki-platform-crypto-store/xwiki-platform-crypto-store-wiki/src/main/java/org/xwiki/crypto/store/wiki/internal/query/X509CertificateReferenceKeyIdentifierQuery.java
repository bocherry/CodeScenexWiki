 ...
 *
 * @version $Id: eb2479606cb4aec94102eefcdb633c5b531c1f17 $
 * @since 6.1M2
 */
public class X509CertificateReferenceKeyIdentifierQuery extends AbstractX509KeyIdentifierQuery
{
     ...
     */
    public X509CertificateReferenceKeyIdentifierQuery(EntityReference store, BinaryStringEncoder encoder,
     ...
     *
     * @param keyIdentifier the subject key identifier to match.
     * @return a matching certificate, or null if none were found.
     */
    public CertificateObjectReference getReference(byte[] keyIdentifier)
    {
        try {
            Object[] result = this.<Object[]>execute(keyIdentifier).get(0);
