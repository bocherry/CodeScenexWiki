 ...
 *
 * @version $Id: f777d525f835c9a62602b92c778a31c5b210d9e6 $
 * @since 6.0
 */
public class SignatureStoreException extends Exception
{
     ...
     *                method.
     */
    public SignatureStoreException(String message)
    {
        super(message);
    }
     ...
     */
    public SignatureStoreException(String message, Throwable cause)
    {
        super(message, cause);
    }
}
