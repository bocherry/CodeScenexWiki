 ...
 * component to resolve {@link ObjectPropertyReference} objects from their string representation. This implementation
 * uses fixed default values when parts of the Reference are missing in the string representation. Default values are
