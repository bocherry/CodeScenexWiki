 ...
 * 
 * @version $Id: 3d7e27201697e90a1fa2bdd943fae6614762a379 $
 */
public class XWikiAttachmentTest
{
    ...
    public void testStoreContentInDiskCache() throws Exception
    {
        ...
        assertTrue(IOUtils.contentEquals(new RandomInputStream(attachLength, seed), attach.getAttachment_content()
