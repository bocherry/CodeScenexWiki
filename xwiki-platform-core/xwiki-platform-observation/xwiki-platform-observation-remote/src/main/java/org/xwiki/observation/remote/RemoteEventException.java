 ...
 *
 * @version $Id: 0c7a3aeec3e65c6260f4a7bd7d2cbd0b02634966 $
 * @since 2.0M3
 */
public class RemoteEventException extends Exception
{
     ...
     */
    public RemoteEventException(String message)
    {
        super(message);
    }
     ...
     */
    public RemoteEventException(String message, Throwable cause)
    {
        super(message, cause);
    }
}
