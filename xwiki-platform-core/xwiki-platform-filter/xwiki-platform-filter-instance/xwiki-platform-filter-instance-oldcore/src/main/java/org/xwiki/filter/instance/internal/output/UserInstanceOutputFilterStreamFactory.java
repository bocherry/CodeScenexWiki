...
/**
 * @version $Id: ee8101c76347773027e69f15aed592ace1511d19 $
 * @since 6.2M1
 */
@Component
@Named(UserInstanceOutputFilterStreamFactory.ROLEHINT)
@Singleton
public class UserInstanceOutputFilterStreamFactory extends
    AbstractBeanOutputInstanceFilterStreamFactory<UserInstanceOutputProperties, UserInstanceOutputFilter>
{
    /**
