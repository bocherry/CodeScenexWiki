...
/**
 * Same as CompactWikiStringEntityReferenceSerializer but with the extended type in the role hint instead of the role
 * type.
 * 
 * @version $Id: 2d7e0b8b6eecfe368ca9cb143458e2e8ae0c36d8 $
 * @since 2.3M1
...
@Singleton
@Deprecated
public class DeprecatedCurrentMixedReferenceDocumentReferenceResolver implements DocumentReferenceResolver
{
    @Inject
    @Named("currentmixed")
