...
/**
 * Same as CurrentReferenceEntityReferenceResolver but with the extended type in both the role hint and the role type.
 * 
 * @version $Id: 036dd1037ac16dbd126ebb4b7c9020b8819b47a6 $
 * @since 2.2M1
...
@Singleton
@Deprecated
public class DeprecatedCurrentReferenceEntityReferenceResolver2 implements EntityReferenceResolver<EntityReference>
{
    @Inject
    @Named("current")
