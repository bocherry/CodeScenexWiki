...
/**
 * Same as DefaultReferenceDocumentReferenceResolver but with the extended type in the role hint instead of the role
 * type.
 * 
 * @version $Id: c0681b09a09ec817e6fd87631ed7eaacfd4e4a4f $
 * @since 2.2M1
...
@Singleton
@Deprecated
public class DeprecatedDefaultReferenceDocumentReferenceResolver implements DocumentReferenceResolver
{
    @Inject
